  ...
  const loadData = async () => {
    ...
    try {
      const [alertsData, hospitalsData, patientsData] = await Promise.all([
        dataClient.entities.DiseaseAlert.list("-created_date", 10),
        dataClient.entities.Hospital.list("-created_date", 50),
        dataClient.entities.PatientData.list("-created_date", 500),
      ]);
