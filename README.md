...
Frontend and backend are now separated in the repo.

## Layout

- `frontend/` - React app, Vite config, frontend env files
...
>>>>>>> eba247aeb15c271ac7fe4c7e7878f640f8659886
```bash
npm run dev
```
...
- Put frontend env values in `frontend/.env.local`
=======
